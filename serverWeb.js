...
const insumo = require("./src/routes/insumosRouter");
...
const io = new Server(server, {
  cors: {
    origin: "http://66.232.105.87:3000",
    methods: ["GET", "POST"],
  },
});
...
app.post("/test-print", (req, res) => {
  ...
  console.log("🔥 TEST OK");
  console.log("📦 COLA:", global.colaImpresion.length);
...
app.get("/api/print", (req, res) => {
  ...
  const data = [...global.colaImpresion];
  global.colaImpresion = [];
