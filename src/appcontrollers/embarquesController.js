...
const obtenerEmbarquesNewTest= async (req, res) => {
  const idUsu = req.params.idUsu; 
  const query = `
      SELECT
      p.id_pedi,
...
module.exports = { obtenerEmbarques, actualizarBahiaEmbarque, obtenerEmbarquesNew, obtenerEmbarquesNewTest };
