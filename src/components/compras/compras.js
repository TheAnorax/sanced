    ...
    try {
      ...
      if (result.isConfirmed) {
        ...
        const response = await axios.put(
          `http://192.168.3.27:3007/api/compras/compras/cancelar/${id_recibo}`, // URL corregida
  ...
  const handleGuardarCantidad = async () => {
    ...
    try {
      ...
      if (result.isConfirmed) {
        ...
        const response = await axios.put(
          `http://192.168.3.27:3007/api/compras/compras/recibo/${selectedProduct.id_recibo}`,
          {
  ...
  const handleAssignToAlmacen7050 = async (compra) => {
    ...
    try {
      ...
      if (result.isConfirmed) {
        ...
        const response = await axios.put(
          `http://192.168.3.27:3007/api/compras/compras/recibo/${compra.id_recibo}`,
          {
  ...
  const fetchCompras2 = async () => {
    try {
      const response = await axios.get(
        `http://192.168.3.27:3007/api/compras/compras?tipo=${tipo}`
      );
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        for (const batch of batches) {
          await axios.post(
            "http://192.168.3.27:3007/api/compras/compras/upload-excel",
            batch
          );
        }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (result.isConfirmed) {
        if (isEditing) {
          await axios.put(
            `http://192.168.3.27:3007/api/compras/recibo/${selectedProduct.id_recibo}`,
            {
              oc,
              cantidad,
          ...
          const userId = user?.id_usu;
          await axios.post("http://192.168.3.27:3007/api/compras/recibo", {
            oc,
            cantidad,
            recepcion: recepcionFormatted,
            codigo: selectedProduct.codigo_pro,
