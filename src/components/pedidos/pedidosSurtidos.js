...
function EnSurtido() {
  ...
  useEffect(() => {
    const fetchPedidos = async () => {
      try {
        const response = await axios.get('http://localhost:3007/api/pedidos-surtidos/pedidos-surtido');
  ...
  const fetchTurnoPedidos = async (turno) => {
    try {
      const response = await axios.get('http://localhost:3007/api/pedidos-surtidos/pedidos-dia'); 
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.put(`http://localhost:3007/api/pedidos-surtidos/pedidos-surtido/${selectedPedido.pedido}`, updatedPedido);
  ...
  const updateAllBahias = async () => {
    try {
      ...
      const response = await axios.put(`http://localhost:3007/api/pedidos-surtidos/pedidos-surtido/${selectedPedido.pedido}/bahias`, {
        ubi_bahia: combinedBahias 
      });
  ...
  const authorizePedido = async () => {
    ...
    try {
      ...
      await axios.post(`http://localhost:3007/api/pedidos-surtidos/pedidos-surtido/${selectedPedido.pedido}/authorize`, { items: updatedItems });
  ...
  const handleCancelPedido = async (pedidoId) => {
    try {
      const response = await axios.put(`http://localhost:3007/api/pedidos-surtidos/pedidos-surtido/${pedidoId}/cancel`, { estado: 'C' });
      if (response.status === 200) {
        const updatedPedidos = pedidos.map(pedido => {
