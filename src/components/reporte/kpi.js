...
function KpiDashboard() {
  ...
  const fetchSurtidoData = async (date) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://192.168.3.154:3007/api/kpi/getPrduSurtido`,
        {
  ...
  const fetchMontacargasData = async (date) => {
    ...
    try {
      const formattedDate = date.format("YYYY-MM-DD");
      const response = await axios.get(
        `http://192.168.3.154:3007/api/historial/kpi`,
        {
          params: { date: formattedDate },
        }
      );
  ...
  const fetchPaqueteriaData = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://192.168.3.154:3007/api/kpi/getPrduPaqueteria`,
        {
          params: { date: formattedDate },
        }
      );
  ...
  const fetchEmbarquesData = async () => {
    ...
    try {
      const formattedDate = selectedDate.format("YYYY-MM-DD");
      const response = await axios.get(
        `http://192.168.3.154:3007/api/kpi/getPrduEmbarque`,
        {
          params: { date: formattedDate },
        }
      );
  ...
  const fetchReciboData = async () => {
    ...
    try {
      const formattedDate = selectedDate.format("YYYY-MM-DD");
      const response = await axios.get(
        `http://192.168.3.154:3007/api/kpi/getPrduRecibo`,
        {
          params: { date: formattedDate },
        }
      );
  ...
  const fetchHistorico = async () => {
    ...
    try {
      const response = await axios.get(
        "http://192.168.3.154:3007/api/kpi/getPrduSurtidoPorRango",
        {
          params: {
  ...
  const fetchHistoricoPaqueteria = async () => {
    try {
      const response = await axios.get(
        "http://192.168.3.154:3007/api/kpi/getPrduPaqueteriaPorrango",
        {
          params: {
            inicio: rangoInicio.format("YYYY-MM-DD"),
            fin: rangoFin.format("YYYY-MM-DD"),
