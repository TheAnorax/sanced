...
export default function MapaMexico() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://66.232.105.87:3007/api/kpi/getHstorico2024");
  ...
  useEffect(() => {
    const fetchTop10 = async () => {
      try {
        const response2024 = await fetch("http://66.232.105.87:3007/api/kpi/getTop102024");
        const data2024 = await response2024.json();
        setTop10(data2024);

        const response2025 = await fetch("http://66.232.105.87:3007/api/kpi/getTop102025");
        const data2025 = await response2025.json();
        setTop10_2025(data2025);

        const responseEstado = await fetch("http://66.232.105.87:3007/api/kpi/getTopProductosPorEstado");
