...
const fetchPedidos = async () => {
  const response = await axios.get('http://192.168.3.154:3007/api/pedidos/pedidos');
  return response.data;
};

// const fetchBahias = async () => {
//   const response = await axios.get('http://192.168.3.154:3007/api/pedidos/bahias'); 
...
const usePedidos = () => {
  ...
  const mutation = useMutation({
    mutationFn: async (pedidoData) => {
      ...
      await axios.post('http://192.168.3.154:3007/api/pedidos/surtir', {
        pedido,
        estado,
        bahias,
        items,
...
const Pedidos = React.memo(() => {
  ...
  const mergePedidos = async () => {
    ...
    try {
      await axios.post('http://192.168.3.154:3007/api/pedidos/merge', mergedPedido);
