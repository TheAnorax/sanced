...
const { getFinalizados, getPedidoDetalles, getMotivos, getClientePorNumero, getFinalizadosPorMes } = require('../controller/finalizadosController');
...
router.get('/detalles-mes', getFinalizadosPorMes);
