...
const { porcentaje, ubicaciones, persona, manual, obtenerInventario, getInventoryDet, reportFinishInventory, reportFinishInventoryAlma, reportConsolidatedInventory} = require('../controller/inventoryController');
